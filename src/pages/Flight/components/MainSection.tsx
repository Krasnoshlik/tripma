...
export default function MainSection() {
  ...
  return (
    <section className=" max-w-7xl m-auto px-4 mb-20">
        <div className=" flex gap-5 flex-col clas:flex-row">
            <div className=" flex flex-col gap-5">
            <h3 className=" text-light-grey">
                Choose a <span className=" text-mainC">departing</span> flight
            </h3>
            ...
            <div className=" border p-4 rounded-xl">
                ...
                return (
                    <div key={i}>
                    {i !== 0 && (
                        <span className=" block h-[1px] w-full bg-gray-200 my-2"></span>
                    )}
                    <FlightDepartLine  e={e} />
                    </div>
                );
                })}
            </div>
            ...
            <div className=" flex flex-col gap-5">
                ...
                <h4>Price rating</h4>
                <p className=" bg-green-500 text-white rounded-md px-2">
                    Buy soon
                </p>
                </div>
